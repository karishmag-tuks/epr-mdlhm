...
# ==============================================
# 2. KIRKHOFF HELMHOLTZ PROPAGATION
# ==============================================
...
def cdlhm_channel_fresnel_with_subtraction(obj_r, obj_i, wavelength, dx, L, z):
    ...
    H = np.sqrt(Ur_tot * Ur_tot + Ui_tot * Ui_tot)
    return A, H
...
A_R, H_R = cdlhm_channel_fresnel_with_subtraction(obj_r, obj_i, wavelengths['R'], dx, L, z)
A_G, H_G = cdlhm_channel_fresnel_with_subtraction(obj_r, obj_i, wavelengths['G'], dx, L, z)
A_B, H_B = cdlhm_channel_fresnel_with_subtraction(obj_r, obj_i, wavelengths['B'], dx, L, z)
